...
public class MissionTextBodyReaderWriterTest {
	...
	@Test
	public void testInputRoverInTheSamePlace() {
		final String input = "5 5\n1 2 N\nLMLMLMLMM\n1 2 E\nMMRMMRMRRM";
		
		assertThatThrownBy(() -> {  
			new MissionTextBodyReader().parseMission("test", new ByteArrayInputStream(input.getBytes(Charset.forName(DEFAULT_ENCODING.value())))); 
